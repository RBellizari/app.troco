...
class ZipCodeFullPage extends StatefulWidget {
  @override
  _ZipCodeFullPage createState() => _ZipCodeFullPage();
}

class _ZipCodeFullPage extends State<ZipCodeFullPage> {
  @override
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Text(
              'Show! Agora só falta          completar seu endereço.',
            ...
            Container(
              ...
              child: SizedBox.expand(
                child: FlatButton(
                  ...
                  onPressed: () => Navigator.pushNamed(context, '/FillPage'),
                ),
              ),
            ),
          ],
