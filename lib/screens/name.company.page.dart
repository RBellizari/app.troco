...
class NameCompanyPage extends StatefulWidget {
  @override
  _NameCompanyPage createState() => _NameCompanyPage();
}

class _NameCompanyPage extends State<NameCompanyPage> {
  @override
                  ...
                  Container(
                    ...
                    child: SizedBox.expand(
                      child: FlatButton(
                        ...
                        onPressed: () =>
                            Navigator.pushNamed(context, '/EmailCompanyPage'),
                      ),
                    ),
                  ),
                  SizedBox(height: 30.0),
